...
if __name__ == '__main__':
	...
	if (argc > 2):
        ...
        #modes=["i_patt_1", "orio_nm_1", "orio_sa_1", "orio_sa_2","orio_sa_3","orio_sa_4","orio_sa_5","orio_sa_6","orio_sa_7","orio_sa_8","orio_sa_9","orio_sa_10"]
        #modes=["orio_sa_1", "orio_sa_2","orio_sa_3","orio_sa_4"]
	#modes=["polly_default_size_1", "no_tiling_1", "i_patt_1", "orio_nm_1", "orio_sa_1"]
        #modes=["s_patt_plus_1", "i_patt_1", "turbo_tiling_1"]
        modes=["turbo_tiling_1"]
	...
	with open(resultDir+'/summary.csv', 'w') as f_out:
                f_out.write(' :')
                for bench in files_dir:
                        #for m in metrics:
                        j=files_dir.index(bench)
